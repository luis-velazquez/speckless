        ...
        <div className="mx-auto max-w-4xl -my-10 6">
          <div className="text-center pb-20">
            ...
            <div className="py-10">
              ...
              <p className="text-gray-800 dark:text-gray-100 font-semibold">The Best in the business!</p>
              <hr className="w-48 h-1 mx-auto my-6 bg-gray-100 border-0 rounded md:my-10 dark:bg-gray-300"/>
            </div>
          </div>
        </div>
      </div>
